...
[rdemko@yew:~/project_home/DJob/DistribJobTasks/bin/dada2]$ ls
buildErrorModels.R  fastqToAsv.R  filterFastqs.R  mergeAsvsAndAssignToOtus.R
[rdemko@yew:~/project_home/DJob/DistribJobTasks/bin/dada2]$ cat buildErrorModels.R 
#! /usr/bin/env R
# This script is designed to be run once per dataset after data files have been filtered
# Given a folder of amplicon sequencing reads, with one file per sample,
# produces error models for the next step of the workflow
